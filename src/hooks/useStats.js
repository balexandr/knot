...
export function useStats() {
  ...
  const recordGame = useCallback((dateKey, solvedCount, totalTriplets) => {
    setStats((prev) => {
      ...
      next.distribution[solvedCount] = (next.distribution[solvedCount] || 0) + 1;
